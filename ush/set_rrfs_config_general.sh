...
if [[ ${PREDEF_GRID_NAME} == "RRFS_CONUS_3km" ]] ; then 
  ...
  if [[ $MACHINE == "orion" ]] ; then
    ...
    MAXTRIES_GET_EXTRN_ICS="4"
    MAXTRIES_GET_EXTRN_LBCS="4"
    MAXTRIES_MAKE_ICS="4"
    MAXTRIES_MAKE_LBCS="4"
    MAXTRIES_RUN_PREPSTART="4"
    MAXTRIES_CLDANL_NONVAR="4"
    MAXTRIES_RECENTER="4"
    MAXTRIES_SAVE_RESTART="4"
    MAXTRIES_PROCESS_BUFR="4"
    MAXTRIES_PROCESS_RADARREF="4"
    MAXTRIES_RUN_FCST="4"
    MAXTRIES_ANAL_GSI="4"
    MAXTRIES_ANAL_ENKF="4"
    MAXTRIES_RUN_POST="4"
    MAXTRIES_RUN_PRDGEN="4"
    MAXTRIES_ANAL_GSI="4"
  fi
fi
